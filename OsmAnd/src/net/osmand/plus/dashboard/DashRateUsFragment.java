	...
	public class PositiveButtonListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			case USER_LIKES_APP:
				...
				Uri uri = Uri.parse(Version.marketPrefix(getMyApplication()) + "org.hcilab.projects.happy.navi");
				...
				try {
					...
					Uri.parse(Version.marketPrefix(getMyApplication()) + "org.hcilab.projects.happy.navi")));
				}
				break;
